...
## General Description
  Users will interact with a Discord Bot to play a scavenger hunting game. The scavengeer hunting game includes text files containing randomly hidden items: Junk or Treasure.
